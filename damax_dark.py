...
# Define dark theme colors for widgets
bg_color = '#2e2e2e'
fg_color = '#f0f0f0'
...
# Create and place widgets with dark theme
file_button = tk.Button(root, text="Select Video File", command=select_file, bg=button_bg_color, fg=button_fg_color)
file_button.pack(pady=10)

status_label = tk.Label(root, text="", bg=bg_color, fg=fg_color)
status_label.pack(pady=10)

question_label = tk.Label(root, text="Enter your question:", bg=bg_color, fg=fg_color)
question_entry = tk.Entry(root, width=50, bg='#3c3c3c', fg=fg_color, insertbackground=fg_color)
ask_button = tk.Button(root, text="Ask", command=ask_question, bg=button_bg_color, fg=button_fg_color)
speech_recognition_button = tk.Button(root, text="Use Speech Recognition", command=speech_recognition, bg=button_bg_color, fg=button_fg_color)

answer_text = tk.StringVar()
answer_box = tk.Label(root, textvariable=answer_text, bg=bg_color, fg=fg_color, wraplength=400)

# Button for text-to-speech
text_to_speech_button = tk.Button(root, text="Read Answer Aloud", command=lambda: text_to_speech(answer_text.get()), bg=button_bg_color, fg=button_fg_color)
